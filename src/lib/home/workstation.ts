...
export const WORKSTATION_DOMAINS: WorkstationDomain[] = [
  {
    ...
    tools: [
      ...
      {
        id: "valve-wall-thickness-rating",
        title: "B16.34 Valve Wall & P-T",
        seoLabel: "ASME B16.34 Valve Wall Thickness Calculator",
        standard: "B16.34 App. VI / Table 2",
        href: "/calculator/valve-wall-thickness-rating/nps4-class300-wcb-200c-metric",
        keywords: [
          "ASME B16.34 Valve Wall Thickness Calculator",
          "Valve body minimum wall thickness Table 3",
          "ASME B16.34 pressure temperature rating",
          "Valve P-T rating calculator",
          "Valve body hydro test pressure B16.34",
        ],
      },
      {
        id: "psv-reaction-force",
        title: "PSV Reaction Force",
        seoLabel: "PSV Reaction Force Calculator",
        standard: "API 520 Part II",
        href: "/calculator/psv-reaction-force/co2-25000kgh-nps4-metric",
        keywords: [
          "PSV Reaction Force Calculator",
          "Safety valve discharge reaction force API 520",
          "Pressure relief valve open discharge force",
          "ASME VIII PSV reaction force calculation",
          "Dynamic load factor PSV nozzle",
        ],
      },
      {
  ...
  },
  {
    ...
    tools: [
      ...
      {
        id: "lifting-lug-rigging-capacity",
        title: "Lifting Lug & Rigging Capacity",
        seoLabel: "Lifting Lug Design and Capacity Calculator",
        standard: "ASME BTH-1 · AISC",
        href: "/calculator/lifting-lug-rigging-capacity/15ton-2lugs-30deg-s355-metric",
        keywords: [
          "Lifting Lug Design and Capacity Calculator",
          "ASME BTH-1 lug design calculation",
          "Lifting pad eye weld stress calculation",
          "Shackle pin hole bearing stress",
          "Lug tear out shear stress calculation",
        ],
      },
      {
        id: "steam-turbine-power-ssc",
        title: "Steam Turbine Power & SSC",
        seoLabel: "Steam Turbine Power Output and SSC Calculator",
        standard: "ASME PTC 6 · IAPWS-IF97",
        href: "/calculator/steam-turbine-power-ssc/60bar-480c-50th-metric",
        keywords: [
          "Steam Turbine Power Output and SSC Calculator",
          "Specific Steam Consumption calculation",
          "ASME PTC 6 steam turbine efficiency",
          "IAPWS-IF97 enthalpy drop turbine power",
          "Condensing steam turbine output MW",
        ],
      },
      {
        id: "shaft-torque-key-sizing",
        title: "Shaft Power, Torque & Key Sizing",
        seoLabel: "Shaft Power Torque and Key Sizing Calculator",
        standard: "DIN 6885 · ASME B17.1",
        href: "/calculator/shaft-torque-key-sizing/45kw-1750rpm-d50mm-s45c-metric",
        keywords: [
          "Shaft Power Torque and Key Sizing Calculator",
          "DIN 6885 parallel key stress calculation",
          "Shaft diameter for torque calculation",
          "Keyway shear and bearing stress",
          "ASME B17.1 key size calculator",
        ],
      },
      {
        id: "api2000-tank-venting",
        title: "API 2000 Tank Venting",
        seoLabel: "API 2000 Tank Venting Calculator",
        standard: "API Std 2000 7th Ed",
        href: "/calculator/api2000-tank-venting/d15m-h12m-pumpin200-metric",
        keywords: [
          "API 2000 Tank Venting Calculator",
          "Storage tank inbreathing outbreathing calculation",
          "Emergency fire venting API 2000",
          "PVRV breather valve sizing",
          "API 650 tank venting requirement",
        ],
      },
    ],
  },
  {
    ...
    tools: [
      ...
      {
        id: "non-metallic-gasket-b1621",
        title: "Non-Metallic Flat Gasket (B16.21)",
        seoLabel: "ASME B16.21 Flat Gasket Dimensions Calculator",
        standard: "B16.21 / VIII-1 App. 2",
        href: "/calculator/non-metallic-gasket-b1621/nps4-class150-ibc-metric",
        keywords: [
          "ASME B16.21 Flat Gasket Dimensions Calculator",
          "Non-metallic gasket dimensions B16.21",
          "ASME B16.5 flange gasket sizes",
          "Full face gasket dimension chart",
          "ASME Section VIII Gasket factor m and y",
        ],
      },
      {
