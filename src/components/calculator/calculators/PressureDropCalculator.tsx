      ...
      inputPanel={
        <div className="flex w-full min-w-0 flex-col gap-2.5 [&_.calc-field]:mb-0 [&_.calc-field]:max-w-none">
          ...
          <FieldSelect
            label="Fluid"
            value={inputs.fluid}
            onChange={(value) => setField("fluid", value as PressureDropFluid)}
          >
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <FieldSelect
              ...
              onChange={(value) =>
                setField("roughness", toNumber(String(value), inputs.roughness))
              }
            >
          ...
          <div className="overflow-hidden rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950/40">
            ...
            {showFittings ? (
              <div className="space-y-2.5 border-t border-slate-200/80 p-3.5 dark:border-slate-800">
                <FieldGroup
                  label="90° LR elbows"
                  hint="L/D = 30 (Crane TP-410 screening)."
                ...
                <FieldGroup
                  label="Globe valves"
                  hint="L/D = 340 — often dominates ΔP."
